...
from apps.inventario.models import Alumno
...
def generar_reporte_alumnos_pdf(request, alumnos):
    ...
    titulo = Paragraph(
        ...
        "<b>Listado General de Alumnos</b>",
    ...
    elementos.append(
        ...
        Paragraph(
            ...
            f"Total de alumnos encontrados: {alumnos.count()}",
